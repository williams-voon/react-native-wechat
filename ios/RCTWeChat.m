...
RCT_EXPORT_METHOD(registerAppWithUniversalLink:(NSString *)appid
                  :(NSString *)link
                  :(RCTResponseSenderBlock)callback)
{
...
- (void)shareToWeixinWithData:(NSDictionary *)aData scene:(int)aScene callback:(RCTResponseSenderBlock)aCallBack
{
    ...
    if (imageUrl.length && _bridge.imageLoader) {
        ...
        NSURLRequest *imageRequest = [NSURLRequest requestWithURL:url];
        [_bridge.imageLoader loadImageWithURLRequest:imageRequest size:CGSizeMake(500, 400) scale:1 clipped:FALSE resizeMode:RCTResizeModeStretch progressBlock:nil partialLoadBlock:nil
